...
import barunlm.baselines.mobile_matched as matched
...
def test_frozen_recipe_is_hash_bound_and_one_recipe() -> None:
    ...
    assert recipe["model"]["expected_unique_parameters"] == 361_821_120
...
def test_run_preregistration_hashes_the_frozen_implementation() -> None:
    ...
    preregistration_path = (
        ...
        / "experiments"
        / "runs"
        / "20260803-1930-mobile-smollm2-matched-s17"
    ...
    assert frozen["external_model_or_service_contacted"] is False
    assert frozen["baseline_downloaded"] is False
    assert frozen["jarvis_resource_created"] is False
