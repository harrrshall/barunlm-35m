"""Frozen matched-adaptation runner for SmolLM2 on Mobile Actions.
...
EXPECTED_UNIQUE_PARAMETERS = 361_821_120
...
RECIPE_PATH = Path(__file__).resolve().parents[3] / "configs" / "mobile_smollm2_matched_v1.json"
# Frozen before any baseline download, training, or model scoring.
RECIPE_SHA256 = "eca8135ff6cc58e14ddd7ddae210becb43462646e7f32d7de5c57fe624bb2f21"
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--generation-batch-size", type=_positive_int, default=64)
